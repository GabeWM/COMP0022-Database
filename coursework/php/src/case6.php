<?php
    ...
    echo '<script>
                ...
                document.getElementById("case6_hide1").classList.add("d-none");
                document.getElementById("case6_hide2").classList.add("d-none");
                document.getElementById("case6_hide3").classList.add("d-none");
          </script>
          <div class="container">
            <div class="row">
