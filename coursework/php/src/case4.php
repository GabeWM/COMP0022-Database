<?php
    ...
    echo '<script>
                ...
                document.getElementById("case4_hide1").classList.add("d-none");
                document.getElementById("case4_hide2").classList.add("d-none");
                document.getElementById("case4_hide3").classList.add("d-none");
          </script>
          <div class="container">
            <div class="row">
